 ...
 */
export function getAllReputableDomains(): string[] {
 ...
 */
export function isReputableDomain(url: string): boolean {
 ...
 */
export function getRetailerType(url: string): string | null {
