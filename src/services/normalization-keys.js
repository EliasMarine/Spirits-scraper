 ...
 */
export const DEFAULT_NORMALIZATION_CONFIG = {
    removeSize: true,
 ...
 */
export function createNormalizedKey(name, config = DEFAULT_NORMALIZATION_CONFIG) {
 ...
 */
export function createMultipleKeys(name) {
 ...
 */
export function extractVariantInfo(name) {
    const info = {};
    // Extract size
 ...
 */
export function groupByNormalizedKey(names) {
