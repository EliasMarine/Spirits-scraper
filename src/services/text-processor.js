...
export class TextProcessor {
     ...
     */
    static normalizeCategory(name, currentCategory) {
        if (!name)
     ...
     */
    static isValidProductDescription(desc) {
     ...
     */
    static extractBrandFromName(name) {
...
export const { fixTextSpacing, normalizeCategory, extractValidAge, isValidProductDescription, normalizeBrandName, processSpirit } = TextProcessor;
